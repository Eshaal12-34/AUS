...
const Gallery = () => {
  const galleryData = [
    { title: "Sports Day", description: "March 2025", imageUrl: "/assets/img/gallery/01.jpg" },
    { title: "Funfair", description: "February 2025", imageUrl: "/assets/img/gallery/02.jpg" },
    { title: "Science Exhibition", description: "January 2025", imageUrl: "/assets/img/gallery/3.jpg"  },
    { title: "Art Competition", description: "December 2024", imageUrl: "/assets/img/gallery/funfair.jpg" },
