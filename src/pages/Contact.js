...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`https://backend-fylo.vercel.app/api/contact`, formData);
            ...
            <div className="row g-4 align-items-center">
              <div className="col-lg-6">
                <div className="contact-left-items">
                  <div className="contact-info-area-2 rounded justify-content-center">
