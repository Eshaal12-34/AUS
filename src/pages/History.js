...
const History = () => {
  ...
  <div style={{ textAlign: "justify" }}>
    <p>
      The foundation of Abasyn University is deeply rooted in the vision and
      commitment of its founder, Dr. Imran Ullah. After completing his MBA from
      Sull State University in the United States in the late 1990s, Dr. Imran
      Ullah chose to return to Pakistan with a determination to contribute to
      the development of higher education in his homeland. His first initiative
      was the establishment of the Abasyn Institute in Peshawar, which began
      offering a range of bachelor’s and master’s degree programs in affiliation
      with Gomal University. This step marked the beginning of a journey toward
      building an institution dedicated to academic excellence, innovation, and
      service to society.
    </p>

    <p>
      Driven by his ambition to create an independent and fully chartered
      university, <b>Dr. Imran Ullah</b> worked tirelessly to secure official
      recognition. His efforts bore fruit in <b>2009</b> when the Khyber
      Pakhtunkhwa Provincial Assembly granted a charter for Abasyn University.
      This milestone transformed the institute into a degree-awarding
      institution, setting the stage for its rapid growth and expansion in the
      years to follow. Building on its momentum, Abasyn University sought to
      extend its educational reach to other regions of Pakistan. In <b>2012</b>,
      the University received a <b>No Objection Certificate (NOC)</b> from the
      Higher Education Commission (HEC) of Pakistan to establish a campus in the
      federal capital, Islamabad. This expansion not only broadened the
      University’s footprint but also enabled it to cater to a more diverse
      student population.
    </p>

    <p>
      Today, Abasyn University operates <b>two thriving campuses</b> — in
     ...
     <p>
            ...
            <p>
              ...
              Recognizing the importance of a strong academic foundation for
              young learners, the University developed a purpose-built campus in{" "}
